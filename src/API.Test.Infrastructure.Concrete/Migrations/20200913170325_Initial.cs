        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeFirstName = table.Column<string>(type: "varchar(255)", nullable: false),
                    EmployeeLastName = table.Column<string>(type: "varchar(255)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Permission_PermissionType_TypeId",
                        column: x => x.TypeId,
